    ...
    >
        <td class="bulk-action">
            <div class="custom-control custom-checkbox active">
                ...
                <label class="custom-control-label" for="<?php echo e('checkboxAll-bulk-'.$listId); ?>">&nbsp;</label>
            </div>
        </td>
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/loasis_online_order/app/admin/widgets/lists/list_actions.blade.php ENDPATH**/ ?>