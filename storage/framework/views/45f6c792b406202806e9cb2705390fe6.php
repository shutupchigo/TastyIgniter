        ...
        <div class="menu-group-item">
            <?php if($categoryId > 0): ?>
                ...
                <div id="category-<?php echo e($menuCategoryAlias); ?>-heading" role="tab">
                    <h4
                        class="category-title cursor-pointer <?php echo e($loop->iteration >= $menuCollapseCategoriesAfter ? 'collapsed' : ''); ?>"
                        data-toggle="collapse"
                        data-target="#category-<?php echo e($menuCategoryAlias); ?>-collapse"
                        aria-expanded="false"
