...
<?php else: ?>
    <div class="input-group">
        <?php if (! ($symbolAfter)): ?>
            <span class="input-group-prepend"><span class="input-group-text"><b><?php echo e($symbol); ?></b></span></span>
        <?php endif; ?>
        <input
        ...
        />
        <?php if($symbolAfter): ?>
            <span class="input-group-append"><span class="input-group-text"><b><?php echo e($symbol); ?></b></span></span>
        <?php endif; ?>
    </div>
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/loasis_online_order/app/admin/widgets/form/field_currency.blade.php ENDPATH**/ ?>