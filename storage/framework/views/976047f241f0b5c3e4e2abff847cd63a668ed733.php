<div class="d-flex w-100 align-items-center">
    <div
        ...
        href="#"
        data-toggle="modal"
        data-target="#extension-modal-<?php echo e($record->extension_id); ?>"
        role="button"
        <?php endif; ?>
    >
                ...
                <div class="modal-header">
                    ...
                    <?php if(isset($record->meta['homepage'])): ?>
                        <button type="button" class="close">
                            <a href="<?php echo e($record->meta['homepage']); ?>"><i class="fa fa-external-link"></i></a>
                        </button>
                    <?php endif; ?>
                </div>
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/loasis_online_order/app/system/views/extensions/lists/extension_card.blade.php ENDPATH**/ ?>