    ...
    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="update-item row pt-3 pb-3 border-top <?php echo e($ignored ? 'text-muted' : ''); ?>">
            ...
            <div class="description col col-sm-7">
                <?php if(isset($item['tags']['data'][0]) && $tag = $item['tags']['data'][0]): ?>
        ...
        <?php if($item['type'] === 'core'): ?>
            <div class="px-3 pb-3 border-bottom"><?php echo app('translator')->get('system::lang.updates.text_core_update'); ?></div>
        <?php endif; ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div>
<?php /**PATH /Applications/MAMP/htdocs/loasis_online_order/app/system/views/updates/list_items.blade.php ENDPATH**/ ?>