                    ...
                    <div class="card card-body <?php echo e(empty($item['installed']) ? 'bg-white' : ''); ?> mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 px-3">
                                ...
                                <span class="help-block font-weight-normal"><?php echo e(str_limit($item['description'], 128)); ?></span>
                            </div>
...
<?php /**PATH /Applications/MAMP/htdocs/loasis_online_order/app/system/views/updates/list_recommended.blade.php ENDPATH**/ ?>